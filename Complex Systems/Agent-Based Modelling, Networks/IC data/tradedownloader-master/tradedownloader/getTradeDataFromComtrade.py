...
class ComtradeApi:
    ...
    def __init__(self, ctry_codes_path="UN Comtrade Country List.csv", fld=""):
        ...
        self._ctry_codes = self._ctry_codes.ix[
            self._ctry_codes['End Valid Year'] == 'Now']
    ...
    #----------------------------------
    def getComtradeData(self, comcodes=['650500', '392620', '401590', '481850', '621010', '621050'], reporter=['all'], partner=['all'],
                        years=[2017], freq='A', rg=['1'], fmt='json', rowmax=50000):
